...
def plot_grid(grid: Grid, state: OptimizationState, title: str = "Power Grid", filename: str = None):
    """
    ...
    nx.draw_networkx_edges(G, pos, edgelist=edges, edge_color=colors, width=widths, arrowstyle='->', arrowsize=20)
    ...
    legend_elements = [
        Line2D([0], [0], marker='o', color='w', label='Generator (Producer)',
               markerfacecolor='lightgreen', markersize=12, markeredgecolor='black'),
        Line2D([0], [0], marker='o', color='w', label='Load (Consumer)',
               markerfacecolor='salmon', markersize=12, markeredgecolor='black'),
        Line2D([0], [0], marker='o', color='w', label='Transmission Hub',
               markerfacecolor='lightgray', markersize=12, markeredgecolor='black'),
