...
def run_tests():
    ...
    final_state, losses = run_optimization(grid, num_steps=10000, learning_rate=2e-4, print_every=1000)
    ...
    if final_state.generation[0] + final_state.generation[1] > 90.0:
        print("PASS: Total generation looks reasonable (> 90 MW for 100 MW load + losses).")
    else:
